...
public class OSSController {
    ...
    String accessId = "LTAI4GEFkmd1cS9pTyK6mCyF"; // 请填写您的AccessKeyId。
    String accessKey = "R3IUv8kLXPRqw6s5CBk5ik65gCsaZn"; // 请填写您的AccessKeySecret。
    String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
    String bucket = "sh-guli1010"; // 请填写您的 bucketname 。
